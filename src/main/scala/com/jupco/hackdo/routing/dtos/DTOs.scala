...
case class CreatePackageRequest(ownerId: String, box: BoxDTO, status: String)
...
case class BoxDTO(length: Double, width: Double, height: Double, weight: Double, volume: Option[Double] = None)
